...
class ErcTvbPlugin:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'ErcTvbPlugin_{}.qm'.format(locale))
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('ErcTvbPlugin', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/erc_tvb_plugin/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'ERC-TVB'),
            callback=self.run,
